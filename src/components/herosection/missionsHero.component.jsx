...
<div className="hero relative text-sm font-bold text-black min-h-[70%]">
    <div className="relative w-full">
        ...
        <div>
            <div style={{backgroundImage: `${bgImg}`, backgroundColor: `${bg}`, opacity: '0.58'}} className="flex relative w-[100%] h-96  justify-center space-x-32 items-center">
                <h1 className="text-6xl font-thin text-white">Missions</h1>
            </div>
        </div>
    </div>
</div>
